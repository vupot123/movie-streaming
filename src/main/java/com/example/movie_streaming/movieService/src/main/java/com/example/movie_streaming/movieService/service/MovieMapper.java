...
public class MovieMapper {
    ...
    public MovieResponse toResponse(Movie movie) {
        return MovieResponse.builder()
                ...
                .trailers(mapTrailers(movie.getTrailers()))
                .banners(mapBanners(movie.getBanners()))
                .actors(mapActors(movie.getMovieActors()))
                .genres(mapGenres(movie.getMovieGenres()))
                .countries(mapCountries(movie.getMovieCountries()))
    ...
    private Set<CountryResponse> mapCountries(Set<MovieCountry> movieCountries) {
        if (movieCountries == null) return Set.of();
        return movieCountries.stream()
                .map(c -> new CountryResponse(c.getCountry().getId(), c.getCountry().getName()))
                .collect(Collectors.toSet());
    }
