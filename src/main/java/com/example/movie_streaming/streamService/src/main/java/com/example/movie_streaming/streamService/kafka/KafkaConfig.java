...
/**
 * Cấu hình Kafka cho ứng dụng, bao gồm producer và consumer factory, KafkaTemplate và listener container.
 */
@Configuration
public class KafkaConfig {
    ...
    /**
     * Cấu hình factory cho producer Kafka.
     * @return ProducerFactory với các tham số cấu hình như bootstrap servers, serializers, và retry.
     */
    @Bean
    ...
    /**
     * Cấu hình KafkaTemplate để gửi message.
     * @return KafkaTemplate với producer factory đã cấu hình.
     */
    @Bean
    ...
    /**
     * Cấu hình factory cho consumer Kafka.
     * @return ConsumerFactory với các tham số cấu hình như bootstrap servers, deserializers, và offset.
     */
    @Bean
